...
namespace NINA.Plugin.TargetScheduler.Test.Planning {
    ...
    public class InstructionGeneratorTest {
        ...
        public void testGenerateNewTarget() {
            ...
            list[2].planExposure.FilterName.Should().Be("L");
            ...
            list[3].planExposure.FilterName.Should().Be("L");
        ...
        public void testGenerateSameTarget() {
            ...
            list[0].planExposure.FilterName.Should().Be("L");
            ...
            list[1].planExposure.FilterName.Should().Be("L");
