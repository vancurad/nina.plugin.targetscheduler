...
namespace NINA.Plugin.TargetScheduler.Test.Flats {
    ...
    public class FlatsExpertTest {
        ...
        public static ImageMetadata GetImageMetadata(int sessionId, string filterName, int gain, int offset, string binning, int readoutMode, double rotation, double roi) {
