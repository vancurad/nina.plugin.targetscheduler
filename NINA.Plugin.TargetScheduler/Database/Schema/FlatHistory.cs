...
namespace NINA.Plugin.TargetScheduler.Database.Schema {
    ...
    public class FlatHistory : IComparable {
        ...
        public DateTime LightSessionDate {
            get { return Common.UnixSecondsToDateTime(lightSessionDate); }
            set { lightSessionDate = Common.DateTimeToUnixSeconds(value); }
        }
        ...
        public DateTime FlatsTakenDate {
            get { return Common.UnixSecondsToDateTime(flatsTakenDate); }
            set { flatsTakenDate = Common.DateTimeToUnixSeconds(value); }
        }
