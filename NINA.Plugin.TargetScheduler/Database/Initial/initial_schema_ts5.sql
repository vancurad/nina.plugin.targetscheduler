/* This is unused but was the original TS5 schema used during TS5 development. */
...
CREATE TABLE IF NOT EXISTS "profilepreference" (
	...
	"autoAcceptLevelHFR"					REAL DEFAULT 0,
	"autoAcceptLevelFWHM"					REAL DEFAULT 0,
	"autoAcceptLevelEccentricity"			REAL DEFAULT 0,
