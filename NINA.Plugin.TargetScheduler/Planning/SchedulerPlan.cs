...
namespace NINA.Plugin.TargetScheduler.Planning {
    ...
    public class SchedulerPlan {
        ...
        public List<IPlanningInstruction> PlanInstructions { get; private set; }
        public DateTime? WaitForNextTargetTime { get; private set; }
        public bool IsEmulator { get; set; }
        public string DetailsLog { get; private set; }

        public SchedulerPlan(DateTime planTime, ITarget planTarget, List<IPlanningInstruction> planInstructions, bool logPlan) {
